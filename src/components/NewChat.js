      ...
      className='absolute z-[99] w-full h-full bg-secondary'>
        ...
        <form  action="" className='w-full'>
          <div  className='h-full w-full py-[6px] bg-primary rounded-lg overflow-hidden flex items-center px-3 transition-all ease-in-out duration-300'>
            ...
            <input id='search-form' type="text" className='px-3 bg-transparent text-icon outline-none placeholder:text-sm ml-4' placeholder={search ? "" : "Search or start new chat"} onFocus={() => setSearch(!search)} />
          </div>
        </form>
          </div>
