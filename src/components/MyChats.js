    ...
    <div className='h-full w-[410px] bg-secondary border-r border-slate-700 relative'>
      ...
      <div className='flex w-full h-[53px] py-[7px] px-3'>
        <form  action="" className='w-full'>
          <div  className='h-[90%] w-full bg-primary rounded-lg overflow-hidden flex items-center px-3 transition-all ease-in-out duration-300'>
            ...
            <input id='search-form' type="text" className='px-3 bg-transparent text-icon outline-none placeholder:text-sm ml-4' placeholder={filter ? "Search unread chats" : "Search or start new chat"} onFocus={() => setSearch(!search)} />
          </div>
        </form>
      ...
      <div className='w-full h-[83%] overflow-y-scroll'>
        ...
        <div className='h-[50px] w-full flex items-center justify-center'>
          <p className='text-sm text-white'>Your personal messages are<span className='text-sky-300'> end-to-end encrypted</span></p>
        </div>
      </div>
    </div>
  )
